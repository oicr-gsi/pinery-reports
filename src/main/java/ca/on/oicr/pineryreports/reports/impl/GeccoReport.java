...
public class GeccoReport extends TableReport {
   ...
   * 
   * @param sequencerRunMap
   *          Hash of sample id to Run, used to lookup runs.
   * @param libSeqIds
   *          Library seq ids.
   * @return A set of run names
   */
  private static Set<String> getRuns(Map<String, Set<RunDto>> sequencerRunMap, Set<String> libSeqIds) {
   ...
   * 
   * @param sampleMap
   *          Hash of sample id to Sample, used to navigate sample hierarchy.
   * @param sample
   *          Starting sample
  ...
  private static Set<String> getLibSeqIds0(Map<String, SampleDto> sampleMap, SampleDto sample, Set<String> result) {
